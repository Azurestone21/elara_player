...
/// 首页组件
class WindowPage extends ConsumerStatefulWidget {
  const WindowPage({super.key});

  @override
  ConsumerState<WindowPage> createState() => _WindowPageState();
}

/// 首页状态管理
class _WindowPageState extends ConsumerState<WindowPage> {
  /// 当前选中的标签页 (0: 视频, 1: 音乐)
  int _currentTab = 1;
