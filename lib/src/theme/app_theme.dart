  ...
  static ThemeData get lightTheme {
    return ThemeData(
      ...
      textTheme: const TextTheme(
        ...
        headlineSmall: TextStyle(fontSize: 20, fontWeight: FontWeight.w600, color: Color(0xFF1E293B)),
        ...
        titleSmall: TextStyle(fontSize: 14, fontWeight: FontWeight.w500, color: Color(0xFF64748B)),
